...
st.set_page_config(page_title="BOL 批量生成工具", page_icon="📦", layout="centered")
...
# ---------- 主界面 ----------
st.title("📦 BOL 批量生成工具")
st.caption("上传腾讯文档导出的 CSV / Excel, 按日期批量生成 Bill of Lading")
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if not groups:
                ...
                for i, (ship_to, items) in enumerate(groups, 1):
                    ...
                    results.append((bol_number, len(items), ship_to, pdf_path))
                ...
                with zipfile.ZipFile(zip_buf, "w") as zf:
                    for bol_number, n, ship_to, pdf_path in results:
